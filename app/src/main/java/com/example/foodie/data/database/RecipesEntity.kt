...
data class RecipesEntity(
 // our recipes table will only have one column, FoodRecipe, which contains a list of Results that we will display on the screen, we only need to store this object to achieve offline caching, since it contains everything we'll need :)
